...
export default function ListTypeConference({ logoURL, title, flagURL, country, date, categories }) {
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Box sx={{ display: 'block' }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'left', alignItems: 'center', marginLeft: 2 }}>
                  <Avatar alt="ES" src={flagURL} className={classes.small} sx={{ mr: 1 }} />
